...
The data folder contains the file regfinal.dta, which is generated by the .do files in the makedata folder and is used for main analysis done in analysis .do files. Underlying SIPP data used in the makedata folder's .do files is available under rawdata. 
